...
function PiyushPersona() {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            const res = await fetch('http://localhost:3001/api/persona/piyush', {
                method: 'POST',
    ...
    return (
        <div className='bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800 text-white h-screen flex flex-col'>
            {/* Header */}
            <div className='bg-gray-800/50 backdrop-blur-sm border-b border-gray-700/50 px-4 py-6 sm:px-6'>
                <div className='max-w-4xl mx-auto'>
                    <div className='flex items-center justify-center gap-4 mb-4'>
                        <div className='relative'>
                            <img 
                                ...
                                alt="Piyush Garg" 
                                className='w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover border-3 border-gradient-to-r from-purple-400 to-pink-400'
                            />
                        ...
                        <div className='text-left'>
                            <h1 className='text-2xl sm:text-3xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-orange-400 bg-clip-text text-transparent'>
                                Piyush Garg
                            </h1>
                    ...
                    <p className='text-gray-400 text-center text-sm sm:text-base'>
                        Chat with AI powered by Piyush's knowledge
                    </p>
                </div>
            </div>
                            ...
                            <div className='text-center text-gray-400 mt-20'>
                                <div className='relative inline-block mb-6'>
                                    <img 
                                        src="../../images/piyush.jpeg" 
                                        alt="Piyush Garg" 
                                        className='w-24 h-24 sm:w-32 sm:h-32 rounded-full object-cover mx-auto border-4 border-gray-700/50'
                                    />
                                    <div className='absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 border-3 border-gray-800 rounded-full flex items-center justify-center'>
                                        <div className='w-4 h-4 bg-green-400 rounded-full animate-pulse'></div>
                                    </div>
                                </div>
                                <p className='text-lg mb-2'>Start a conversation with Piyush</p>
                                <p className='text-sm'>Ask anything about education technology, content creation, or entrepreneurship!</p>
                            </div>
                        )}
                ...
                <div className='max-w-4xl mx-auto'>
                    <div className='flex gap-3 sm:gap-4'>
                        <div className='flex-1 relative'>
                            <textarea
                                className='w-full bg-gray-700/50 border border-gray-600/50 rounded-xl px-4 py-3 sm:px-5 sm:py-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 resize-none backdrop-blur-sm transition-all duration-200 text-sm sm:text-base'
